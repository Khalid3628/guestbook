...
if(isset($_POST['upload'])) {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($result != 0) {
            ...
            echo "Add User Administrator '$username' SUSCESS";
            exit;
...
<html>
    ...
    <body>
        ...
        <form action="<?php $PHP_SELF ?>" method="post" name="uploading" id="uploadform">
    <table width="90%" border="0" align="center" cellpadding="2" cellspacing="2" class="content">
        ...
        <tr>
            ...
            <td width="2%">:</td>
            <td width="72%"><input name="tusername" type="text" id="tusername" size="20" maxlenght="20">
        ...
        <tr>
            ...
            <td>:</td>
            <td><input name="tpassword" type="password" id="tpassword" size="20" maxlenght="20">
        <span class="style2">*</span>
    </td>
        </tr>
        <tr>
